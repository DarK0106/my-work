...
<header class="navbar bg-white border-b border-slate-200 px-4 md:px-8">
	...
	<div class="flex-none">
		<ul class="menu menu-horizontal px-1 text-slate-700 font-semibold items-center">
			...
			<li class="dropdown dropdown-hover dropdown-end">
				...
				<ul tabindex="0" class="dropdown-content menu bg-white rounded-xl z-[10] w-48 p-2 shadow-sm border border-slate-200">
