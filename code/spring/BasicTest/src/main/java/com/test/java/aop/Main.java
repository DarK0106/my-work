...
public class Main {
	public static void main(String[] args) {
		 ...
		 * 	- 관점 지향 프로그래밍 
		 * 	- 주 업무 코드와 보조 업무 코드를 나눠서 표현 -
		 * 보통 주 업무와 보조 업무를 같은 파일에 작성하는 경우가 흔했다 
		 * -> 코드 관리가 불편함, 가독성 저하, 중복 코드 발생 
		 * - 이걸 해결하기 위해서 중복되는 보조업무들이 주 업무에 
		 * 횡단으로 끼어들어서 들어가는 식으로 해결? 
		 * 횡단 관심사(Cross-Cutting Concerns)? core concern?
		 * 
		 * 
		 * 
		 * 
